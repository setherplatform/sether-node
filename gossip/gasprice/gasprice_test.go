...
import (
	params2 "github.com/setherplatform/sether-node/params"
	"math/big"
	"testing"
...
type TestBackend struct {
	...
	rules             params2.ProtocolRules
	pendingRules      params2.ProtocolRules
	pendingTxs        []fakeTx
}
...
func (t TestBackend) GetRules() params2.ProtocolRules {
	return t.rules
}

func (t TestBackend) GetPendingRules() params2.ProtocolRules {
...
func TestOracle_EffectiveMinGasPrice(t *testing.T) {
	backend := &TestBackend{
		block:             1,
		totalGasPowerLeft: 0,
		rules:             params2.FakeNetRules(),
		pendingRules:      params2.FakeNetRules(),
	}
