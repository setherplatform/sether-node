...
import (
	...
	"github.com/setherplatform/sether-node/utils/adapters/vecmt2dagidx"
...
func newTestEnv(firstEpoch idx.Epoch, validatorsNum idx.Validator) *testEnv {
	...
	genStore := makefakegenesis.FakeGenesisStoreWithRulesAndStart(validatorsNum, utils.ToSeth(genesisBalance), utils.ToSeth(genesisStake), rules, firstEpoch, 2)
