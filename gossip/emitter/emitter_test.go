...
import (
	...
	"github.com/setherplatform/sether-node/gossip/emitter/mock"
	"github.com/setherplatform/sether-node/inter"
	"github.com/setherplatform/sether-node/vecmt"
)

//go:generate go run github.com/golang/mock/mockgen -package=mock -destination=mock/world.go github.com/setherplatform/sether-node/gossip/emitter External,TxPool,TxSigner,Signer
