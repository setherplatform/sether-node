...
import (
	...
	"github.com/setherplatform/sether-node/cmd/cmdtest"
)

func tmpdir(t *testing.T) string {
	dir, err := ioutil.TempDir("", "sether-test")
	if err != nil {
		t.Fatal(err)
	}
	return dir
...
func init() {
	// Run the app if we've been exec'd as "sether-test" in exec().
	reexec.Register("sether-test", func() {
...
func exec(t *testing.T, args ...string) *testcli {
	...
	// Boot "sether". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("sether-test", args...)
