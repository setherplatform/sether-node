...
import (
	...
	"github.com/setherplatform/sether-node/cmd/sether/launcher/metrics"
	"github.com/setherplatform/sether-node/cmd/sether/launcher/tracing"
	"github.com/setherplatform/sether-node/debug"
	"github.com/setherplatform/sether-node/evmcore"
	"github.com/setherplatform/sether-node/flags"
	...
	"github.com/setherplatform/sether-node/utils/errlock"
	"github.com/setherplatform/sether-node/valkeystore"
	_ "github.com/setherplatform/sether-node/version"
)

const (
	// clientIdentifier to advertise over the network.
	clientIdentifier = "sether-node"
)
...
var (
	...
	app = flags.NewApp(gitCommit, gitDate, "sether command line interface")
...
func initFlags() {
	...
	nodeFlags = append(nodeFlags, setherFlags...)
...
// sether is the main entry point into the system if no special subcommand is ran.
...
func makeNode(ctx *cli.Context, cfg *config, genesisStore *genesisstore.Store) (*node.Node, *gossip.Service, func()) {
	...
	svc, err := gossip.NewService(stack, cfg.Sether, gdb, blockProc, engine, dagIndex, newTxPool, haltCheck)
	if err != nil {
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	// Create a client to interact with local sether node.
