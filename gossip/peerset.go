...
var (
	...
	// errSnapWithoutSether is returned if a peer attempts to connect only on the
	// snap protocol without advertizing the sether main protocol.
	errSnapWithoutSether = errors.New("peer connected on snap without compatible sether support")
)
