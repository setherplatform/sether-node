...
ENTRYPOINT ["sether", "--datadir=/data", "--testnet", "--tracenode", "--genesis=/data/genesis.g", "--genesis.allowExperimental", "--verbosity=4", "--cache=3600", "--http", "--http.addr=0.0.0.0", "--http.corsdomain=*", "--http.api=eth,web3,net,txpool,art,abft,debug", "--ws", "--ws.addr=0.0.0.0", "--ws.origins=*", "--ws.api=eth,web3,net,txpool,art,abft,debug", "--validator.password=/data/password"]
