...
import (
	...
	"github.com/setherplatform/sether-node/eventcheck"
	"github.com/setherplatform/sether-node/eventcheck/bvallcheck"
	"github.com/setherplatform/sether-node/eventcheck/epochcheck"
	"github.com/setherplatform/sether-node/eventcheck/evallcheck"
	"github.com/setherplatform/sether-node/eventcheck/heavycheck"
	"github.com/setherplatform/sether-node/eventcheck/parentlesscheck"
	"github.com/setherplatform/sether-node/evmcore"
	"github.com/setherplatform/sether-node/gossip/protocols/blockrecords/brprocessor"
	"github.com/setherplatform/sether-node/gossip/protocols/blockrecords/brstream"
	"github.com/setherplatform/sether-node/gossip/protocols/blockrecords/brstream/brstreamleecher"
	"github.com/setherplatform/sether-node/gossip/protocols/blockrecords/brstream/brstreamseeder"
	"github.com/setherplatform/sether-node/gossip/protocols/blockvotes/bvprocessor"
	"github.com/setherplatform/sether-node/gossip/protocols/blockvotes/bvstream"
	"github.com/setherplatform/sether-node/gossip/protocols/blockvotes/bvstream/bvstreamleecher"
	"github.com/setherplatform/sether-node/gossip/protocols/blockvotes/bvstream/bvstreamseeder"
	"github.com/setherplatform/sether-node/gossip/protocols/dag/dagstream"
	"github.com/setherplatform/sether-node/gossip/protocols/dag/dagstream/dagstreamleecher"
	"github.com/setherplatform/sether-node/gossip/protocols/dag/dagstream/dagstreamseeder"
	"github.com/setherplatform/sether-node/gossip/protocols/epochpacks/epprocessor"
	"github.com/setherplatform/sether-node/gossip/protocols/epochpacks/epstream"
	"github.com/setherplatform/sether-node/gossip/protocols/epochpacks/epstream/epstreamleecher"
	"github.com/setherplatform/sether-node/gossip/protocols/epochpacks/epstream/epstreamseeder"
	"github.com/setherplatform/sether-node/gossip/protocols/snap/snapstream/snapleecher"
	...
	"github.com/setherplatform/sether-node/logger"
)
...
// newHandler returns a new Sether sub protocol manager. The Sether sub protocol manages peers capable
// with the Sether network.
func newHandler(
	c handlerConfig,
) (
	*handler,
...
func (h *handler) handle(p *peer) error {
	...
	if !useless && (!eligibleForSnap(p.Peer) || !strings.Contains(strings.ToLower(p.Name()), "sether")) {
		useless = true
		discfilter.Ban(p.ID())
	}
