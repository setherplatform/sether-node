...
const (
	DefaultP2PPort  = 22220 // Default p2p port for listening
	DefaultHTTPPort = 20545 // Default TCP port for the HTTP RPC server
	DefaultWSPort   = 20546 // Default TCP port for the websocket RPC server
)
...
func DefaultDataDir() string {
	...
	if home != "" {
		...
		case "windows":
			...
			return filepath.Join(appdata, "Sether")
		default:
			return filepath.Join(home, ".sether")
		}
	}
